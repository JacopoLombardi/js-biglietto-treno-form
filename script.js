...
btn_1.addEventListener('click', function(){
   ...
   document.querySelector('.out_priceticket').innerHTML = `&euro;${prezzoFinale}`;


   // numero carrozza - da 1 a 10
   let nCarrozza = Math.floor(Math.random () * 11);
   document.querySelector('.out_carrozza').innerHTML =`${nCarrozza}`;


   // Codice CP - da 10.000 a 90.000
   let nCp = Math.floor(Math.random() * (90000 - 10000 + 1)) + 10000;
